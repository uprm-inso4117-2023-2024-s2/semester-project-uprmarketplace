...
export default function SignUp() {
  ...
  const questions = [
    ...
    { q: "What model was your first car?" },
    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        >
            ...
            <TextInput
              ...
              onChangeText={(e: string) => {
                ...
                const check = e
                  .charAt(e.length - 1)
                  .match(/[0-9]/g);
                if((check || e.length == 0) && e.length <= 10) setPhoneNumber(e);
              }}
              style={styles.input}
          ...
          <View>
            <Text style={styles.inputLabel}>Select a security question</Text>
            <Dropdown
              value={selectedQuestion}
              data={questions}
              labelField="q"
              valueField="q"
              onChange={(e: any) => setSelectedQuestion(e)}
          ...
          <View>
            <Text style={styles.inputLabel}>Answer to security question</Text>
            <TextInput
              value={securityAnswer}
              onChangeText={setSecurityAnswer}
              style={styles.input}
              placeholder="Security question response"
              placeholderTextColor="gray"
              // secureTextEntry={!passwordVisible}
            />
          </View>
