...
const data = [
  {
    ...
    price: "$40",
    description:
      "En buenas condiciones, levemente usado, for info call 787-040-2495.",
  },
  {
    id: "2",
    ...
    price: "$75",
    description:
      "Comunicarse al 787-440-9132. Gomas nueva, corre bien y no tiene daños en la pintura. Area de Mayaguez",
  },
  {
    id: "3",
    ...
    price: "$100",
    description: "Poco uso, info: 312-194-1948",
  },
